...
list.pkgs <- c("data.table", "pbapply", "pheatmap", "DESeq2", "Rcpp", "vegan", "ggplot2","ade4","directlabels", "ggVennDiagram", "plyr", "reshape2", "ggprism", "ggpmisc", "circlize","naturalsort", "scales", "magick", "dplyr", "ggsci",  "gridextra", "ggpubr")
