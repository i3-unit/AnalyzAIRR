...
```
<figcaption align = "center"><em class="special">Figure 7: Stacked bars showing the proportion (upper plot) and the cumulative frequency (lower plot) of clones within each count interval in each sample.</em></figcaption>
<br>
...
```
<figcaption align = "center"><em class="special">Figure 9: Barplots showing the proportion (upper plot) and the cumulative frequency (lower plot) of clones within each count interval for a selected sample.</em></figcaption>
<br>
...
```
<figcaption align = "center"><em class="special">Figure 16: Boxplots showing the frequency of each J gene within each group of samples. A Wilcoxon test was performed. Only significant values are plotted.</em></figcaption>
<br>
