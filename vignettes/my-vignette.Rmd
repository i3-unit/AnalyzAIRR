...
```
<figcaption align = "center"><em class="special">Figure 7: Stacked bars showing the proportion (left plot) and the cumulative frequency (right plot) of clones within each count interval in each sample.</em></figcaption>
<br>
