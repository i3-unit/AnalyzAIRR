...
plotCountIntervals(x=RepSeqData, level="clone", fractions="frequency")
```
...
plotIndCountIntervals(RepSeqData,level = "clone", sampleName="tripod-30-813", fractions="frequency")
```
...
plotCountIntervals(x=RepSeqData, level="clone", groupBy = c("cell_subset","sex"), fractions="frequency")
```
